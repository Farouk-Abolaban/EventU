...
import { useUser, SignInButton, ClerkProvider } from "@clerk/nextjs";
      ...
      <section className="container px-4 py-12 md:py-20">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2">
            <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">Welcome to EventU!</h1>
      ...
      <h1 className="logo">Montclair State University</h1>
          ...
          <nav className="mt-4 md:mt-0">
            <ul className="flex gap-6">
              ...
              <li><Link href="#" className="nav-link">Events</Link></li>
              <li><Link href="#" className="nav-link">Calendar</Link></li>
  ...
  Upcoming Featured Events
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {featuredEvents.map(event => (
            <div key={event.id} className="event-card hover:shadow-lg transition">
              ...
              <div className="p-5">
                <div className="event-date mb-1">{event.date} • {event.time}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="footer-link">Our Team</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="footer-link">Event Guidelines</Link></li>
                <li><Link href="#" className="footer-link">Event Planning</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="footer-link">Accessibility</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="footer-link">LinkedIn</Link></li>
              </ul>
            </div>
          </div>
